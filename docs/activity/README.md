...
| [07_file_upload.puml](07_file_upload.puml) | Загрузка файла (аватар / изображение скрипта) |
| [08_expert_sandbox.puml](08_expert_sandbox.puml) | Тестирование скрипта в песочнице эксперта |
